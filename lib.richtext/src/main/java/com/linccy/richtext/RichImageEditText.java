...
import com.linccy.richtext.span.URLSpan;
...
public class RichImageEditText extends RichEditText implements TextWatcher {
    ...
    public RichImageEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public RichImageEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

//    @SuppressWarnings("NewApi")
//    public RichImageEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
//        super(context, attrs, defStyleAttr, defStyleRes);
//        init(attrs);
//    }

    private void init(AttributeSet attrs) {
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.RichImageEditText);
        bulletColor = array.getColor(R.styleable.RichImageEditText_bulletColor, 0);
        bulletRadius = array.getDimensionPixelSize(R.styleable.RichImageEditText_bulletRadius, 0);
        bulletGapWidth = array.getDimensionPixelSize(R.styleable.RichImageEditText_bulletGapWidth, 0);
        historyEnable = array.getBoolean(R.styleable.RichImageEditText_historyEnable, true);
        historySize = array.getInt(R.styleable.RichImageEditText_historySize, 100);
        linkColor = array.getColor(R.styleable.RichImageEditText_linkColor, 0);
        linkUnderline = array.getBoolean(R.styleable.RichImageEditText_linkUnderline, true);
        quoteColor = array.getColor(R.styleable.RichImageEditText_quoteColor, 0);
        quoteStripeWidth = array.getDimensionPixelSize(R.styleable.RichImageEditText_quoteStripeWidth, 0);
        quoteGapWidth = array.getDimensionPixelSize(R.styleable.RichImageEditText_quoteCapWidth, 0);
        array.recycle();
...
//        Glide.with(getContext()).load(uri).asBitmap().thumbnail(0.1f).centerCrop().into(new SimpleTarget<Bitmap>() {  加载本地图片会失败
    ...
    public void fromHtml(String source, final Drawable holder) {
        SpannableStringBuilder builder = new SpannableStringBuilder();
        builder.append(HtmlParser.fromHtml(source, new GlideImageGetter(getContext(), this) {
