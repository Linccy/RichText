...
import com.linccy.richtext.img.UrlDrawable;
...
//        mTextView.setTag(R.id.img_tag, this);
    ...
    private class GifTarget extends SimpleTarget<GifDrawable> {
        ...
        public void onLoadStarted(Drawable placeholder) {
            ...
            int w = getScreenSize(mContext).x;
            int hh = placeholder.getIntrinsicHeight();
            int ww = placeholder.getIntrinsicWidth();
            int high = hh * (w - 40) / ww;
    ...
    protected abstract Drawable getPlaceholder();
}
